...
\begin{tikzpicture}[scale=0.75]
    %\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{/home/chris/DELETEME/screenshot.png}};
...
\caption{The Wundt curve, reproduced from \cite{berlyne1970novelty}. The author describes ``hedonic value'' and ``arousal potential'' as terms meant to cover \textquote{both reward value\dots and preference or pleasure}, and \textquote{all the stimulus properties that tend to raise arousal, including novelty and complexity}, respectively.}
