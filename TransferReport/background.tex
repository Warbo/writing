...
\iffalse TODO: Say bold letters will denote vectors \fi
\iffalse TODO: Maybe stick more closely to vectors, rather than sequences? \fi
...
\begin{itemize}
  \item We fix the number of clusters at $k = \lceil \sqrt{n} \rceil$. \iffalse TODO: Any reason for this choice? YES: It should be n/max! \fi
  ...
  \item We will use \emph{k-means} clustering, implemented by Lloyd's algorithm. \iffalse TODO:Citation Lloyd, S. P. (1957). "Least square quantization in PCM". Bell Telephone Laboratories Paper. Published in journal much later: Lloyd., S. P. (1982). "Least squares quantization in PCM" (PDF). IEEE Transactions on Information Theory 28 (2): 129–137. doi:10.1109/TIT.1982.1056489. Retrieved 2009-04-15. \fi
\end{itemize}
...
K-means is a standard algorithm, available in a variety of machine learning systems. We use the implementation provided by Weka \citep{Holmes.Donkin.Witten:1994}, due to its successful use by ML4PG.
