...
the most-downloaded packages from \textsc{Hackage} (as of 2015-10-30), including
...
theory exploration runs, due to the use of constraints like \qcheck{}'s
...
measuring the direct impact on \qspec{} performance on real code examples,
