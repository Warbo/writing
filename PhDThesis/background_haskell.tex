...
user's dedicated efforts, and hence theory exploration would be unlikely to
...
\item The existence of theory exploration systems such as \hspec{}, and related
  tools which we may be able to re-use, including conjecture generators like
  \qspec{}; counterexample finders like \qcheck{}, \textsc{SmallCheck} and
  \textsc{SmartCheck}; theorem provers like \textsc{Hip}
  \cite{rosen2012proving}; and other related testing and term-generating
  systems like \textsc{MuCheck} \cite{le2014mucheck}, \textsc{MagicHaskeller}
  \cite{katayama2011magichaskeller} and \textsc{Djinn}
  \cite{augustsson2005djinn}.
