...
\iffalse TODO: Alison: This is very clear and good. Each chapter should have
this at the start \fi
...
\begin{figure}
  \centering
  \scalebox{0.5}{\input{images/steppedall.pgf}}
  \scalebox{0.5}{\input{images/timeoutsall.pgf}}
  \scalebox{0.5}{\input{images/steppednontoxic.pgf}}
  \scalebox{0.5}{\input{images/timeoutsnontoxic.pgf}}
