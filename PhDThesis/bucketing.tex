...
\begin{figure}
  \centering
  \scalebox{0.66}{\input{images/steppedall.pgf}}
  \scalebox{0.66}{\input{images/timeoutsall.pgf}}
  \scalebox{0.66}{\input{images/steppednontoxic.pgf}}
  \scalebox{0.66}{\input{images/timeoutsnontoxic.pgf}}
