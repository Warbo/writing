...
\begin{enumerate}
  ...
  \item Analyse the performance of theory exploration on the TEBenchmark problem
    set.
...
infeasible), as required to study the effects of signature selection, we have used the
\tebenchmark{} of section~\ref{sec:tebenchmark}, which is based on the Tons of
Inductive Problems (TIP) problem set for theorem provers~\cite{claessen2015tip}.
