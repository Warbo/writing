...
We use a simplified syntax for the GHC Core language, given below in BNF style ($[]$ and $(,)$ denote repetition and grouping, respectively). We mechanically translate the full GHC Core language into this sub-set, which does not contain types, prior to performing recurrent clustering.
