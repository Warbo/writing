...
sizes QuickSpec was found to be faster, with 95\% confidence. The speedup for
each size is given in table~\ref{FIXME}. The 95\% confidence interval for the
proportion of sample sizes where QuickSpec's median running time is faster than
IsaCoSy's is 66.9\% to 98.2\%.
