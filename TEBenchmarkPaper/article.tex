...
\begin{table}
  ...
  \begin{tabular}{ |l|l|c|c|c|c|c|c| }
    ...
    \tRow{QuickSpec   & \tEQ               &   X &   X &     &     &   X &    }
    \tRow{Speculate   & conditional \tEQ   &   X &   X &     &   A &   X &    }
    \tRow{IsaCoSy     & \tEQ               &   X &   X &     &     &   X &   X}
    \tRow{IsaScheme   & \tEQ               &   X &   X &     &     &   X &   X}
  \end{tabular}
...
continuously or interactively (perhaps akin to McCarthy's ``advice taker'').%FIXME~\cite{}.
