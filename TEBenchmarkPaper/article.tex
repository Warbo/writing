...
Tools for automated theorem proving (ATP) have been shown to benefit from the
addition of a conjecture generator, improving their ability to prove properties
relevant to software verification~\cite{Claessen.Johansson.Rosen.ea:2013}.
