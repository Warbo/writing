{ fail, fetchgit, jq, lzip, mkBin, nixListToBashArray, perl, python, R,
  replace, rPackages, runCommand, teBenchmark, tetex, tex, textWidth, which,
  wrap, writeScript }:
...
rec {
  ...
  graphDims = {
    timeWidthFraction     = "0.5";
    timeHeightFraction    = "0.2";
    precRecWidthFraction  = "0.5";
    precRecHeightFraction = "0.4";
  };
